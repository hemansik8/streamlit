...
def main():
    ...
    """
    st.header("Jewellery Detection with Roboflow")
...
def logo_detection():
    """Jewellery Detection with Roboflow"""

    ##########
    ##### Set up sidebar
    ##########

    st.sidebar.write("### Jewellery Detection")
    ...
    endpoint = "?model=jewellery_detect&version=17&api_key=PIkYh0LVnCFYKv6oiZb1"
